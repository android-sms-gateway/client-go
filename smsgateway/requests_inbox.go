...
type ListInboxOptions struct {
	...
	IncludeAttachments *bool                `query:"includeAttachments"` // Include attachment metadata in response (for MMS messages).
}
...
func (o ListInboxOptions) ToURLValues() url.Values {
	...
	if o.IncludeAttachments != nil {
		values.Set("includeAttachments", strconv.FormatBool(*o.IncludeAttachments))
	}
